...
export function decorateMain(main) {
  ...
  statsSection.innerHTML = `
    <div style="background-color: #ffffff; padding: 60px 5% 80px; font-family: 'Inter', sans-serif; max-width: 1200px; margin: 0 auto;">
      <div style="display: flex; gap: 40px; justify-content: space-between; flex-wrap: nowrap;">
        <div style="display: flex; flex-direction: column; flex: 1; min-width: 0;">
          <div style="font-size: 64px; font-weight: 100; color: #2c2c2c; margin-bottom: 12px; line-height: 1;">$1B</div>
        ...
        <div style="display: flex; flex-direction: column; flex: 1; min-width: 0;">
          <div style="font-size: 64px; font-weight: 100; color: #2c2c2c; margin-bottom: 12px; line-height: 1;">259K</div>
        ...
        <div style="display: flex; flex-direction: column; flex: 1; min-width: 0;">
          <div style="font-size: 64px; font-weight: 100; color: #2c2c2c; margin-bottom: 12px; line-height: 1;">4M</div>
        ...
        <div style="display: flex; flex-direction: column; flex: 1; min-width: 0;">
          <div style="font-size: 64px; font-weight: 100; color: #2c2c2c; margin-bottom: 12px; line-height: 1;">2B+</div>
